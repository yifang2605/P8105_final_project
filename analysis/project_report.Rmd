...
* Homogeneity of variance: It can be seen that the variability (variances) of the residual points is roughly same with the value of the fitted outcome variable, suggesting overall constant variances in the residuals errors (or heteroscedasticity).
